...
#define default_mqtt_address "gt.wildc.net:1884"
#define default_mqtt_username "windytron"
#define default_mqtt_password "jun1windyblow"
#define default_mqtt_root "mesh"
